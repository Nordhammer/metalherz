                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h2 class="mb-1"><strong>Blog bearbeiten</strong></h2>
                                <h3 class="mb-3">
                                    Mitglied seit: 26. Juli 2018
                                </h3>

                                <form class="" method="POST" action="/blog-erstellen" accept-charset="UTF-8" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="inhalt">Untertitel</label>
                                                <textarea class="form-control" name="subtitle" cols="50" rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
